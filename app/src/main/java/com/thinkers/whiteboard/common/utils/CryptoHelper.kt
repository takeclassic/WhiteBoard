...
object CryptoHelper {
    ...
    suspend fun decryptPassCodeAesGcm(): String = withContext(Dispatchers.Default) {
        ...
        val ivStr: String =
            WhiteBoardApplication.instance!!.dataStoreHelper.getStringValue(DataStoreKeys.STRING_KEY_IV)
                .first()
        ...
        val aadStr: String =
            WhiteBoardApplication.instance!!.dataStoreHelper.getStringValue(DataStoreKeys.STRING_KEY_AAD)
                .first()
